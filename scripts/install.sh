...
arch=`uname -m`
url="https://github.com/Cheneytt/helm-push/releases/download/v${version}/helm-push_${version}_${os}_${arch}.tar.gz"
...
echo "  helm repo add repo-name https://yournexushost/repository/yourhelmhost/ --username yourusername --password yourpassword"
echo
